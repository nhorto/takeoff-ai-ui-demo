...
export const landingChannel: PATemplate = {
  ...
  variables: [
    ...
    // ─── Supports (channels + connections) ─────────────────────────────────
    {
      ...
      description: "Channel used for the back and side rails of the frame.",
      type: "dimension",
      shapeFilter: ["C", "MC"],
    ...
    },
    {
      ...
      description: "Channel at the front of the landing (often lighter).",
      type: "dimension",
      shapeFilter: ["C", "MC"],
    ...
    },
    {
      ...
      description: "Angle or channel running between frame members.",
      type: "dimension",
      shapeFilter: ["L", "C", "MC"],
