...
/**
 * Collapsible materials table for any entity editor. Defaults to collapsed;
 * collapse state is local (not persisted). Renders an error banner above
 * the table for each source that blew up during evaluation.
 */
