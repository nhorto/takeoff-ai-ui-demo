...
export function WorkbenchSidebar({
  ...
  return (
    <aside className="flex min-h-0 border-b border-white/[0.05] bg-[#252526] md:border-b-0 md:border-r md:border-r-white/[0.05]">
      <div className="flex w-12 shrink-0 flex-col items-stretch border-r border-white/[0.04] bg-[#1c1c1c] py-2">
        <RibbonButton
      ...
      {!collapsed && (
        <div className="flex min-h-0 w-64 flex-col">
          <div className="flex items-center justify-between border-b border-white/[0.05] px-3 pt-3 pb-2">
